            ...
            <div className="quienes-profiles">
              <div className="profile-card">
                <div className="profile-image-container">
                  <img src="./src/Images/LOW.png" alt="Nicolás Low Tanne" className="profile-image" />
                </div>
              ...
              <div className="profile-card">
                <div className="profile-image-container">
                  <img src="./src/Images/DAN.png" alt="Dan Segal" className="profile-image" />
                </div>
                <div className="profile-info">
              ...
              <div className="profile-card">
                <div className="profile-image-container">
                  <img src="./src/Images/NICO.png" alt="Nicolás Fernandez" className="profile-image" />
                </div>
                <div className="profile-info">
            ...
            <div className="ongs-carousel">
              <div className="carousel-content">
                <div className="partner-logo">
                  <img src="./src/Images/image 2.png" alt="Organización 1" className="partner-image" />
                </div>
                <div className="partner-logo">
                  <img src="./src/Images/image 3.png" alt="Organización 2" className="partner-image" />
                </div>
                <div className="partner-logo">
                  <img src="./src/Images/image 4.png" alt="Organización 3" className="partner-image" />
                </div>
              </div>
            </div>
          </div>
